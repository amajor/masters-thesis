...
\todo{THE PROBLEM: quality of softare architecture is important to a project, but difficult to understand and measure... having metrics that can be checked at beginning and life of project; makes it faster to review architecture than doing by hand. Makes sure project stays maintainable with every sprint, every merge}
